...
- C++ event queue helper for immediate, SOC, daily and archive review lanes.
...
- Read-only public demo controls plus synthetic event boundary, queue and playbook reporting in the UI.
